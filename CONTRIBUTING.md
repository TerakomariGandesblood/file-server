...
Before reporting an issue on the [issue tracker](https://github.com/TerakomariGandesblood/file-server/issues),
...
```shell
git clone https://github.com/TerakomariGandesblood/file-server
cd cli
cargo test
```
